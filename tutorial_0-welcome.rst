...
Make sure to start the kernel named ``EBRAINS-22.07`` by either selecting the E symbol or by choosing the kernel from the list of available kernels when asked to.
